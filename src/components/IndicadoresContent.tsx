  ...
  const gerenciasData = [
    ...
    },
    {
      ...
      indicadores: [
        ...
        'Conversão de Estimados em Medidos'
      ],
    ...
    return (
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            <button 
              onClick={() => setSelectedGerencia(null)}
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {gerenciasData.map((gerencia) => (
          <Card key={gerencia.id} className="overflow-hidden hover:shadow-lg transition-shadow">
            ...
            <div className="p-4">
              ...
              <button 
                ...
                className={`w-full bg-gradient-to-r ${gerencia.cor} text-white py-2 px-4 rounded-lg hover:opacity-90 transition-opacity flex items-center justify-center gap-2`}
              >
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        <Card className="p-6 bg-gradient-to-r from-green-500 to-green-600 text-white">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm opacity-90">Total Usuários Regularizados</p>
              <p className="text-3xl font-bold">228</p>
            </div>
            <CheckCircle className="w-12 h-12 opacity-80" />
          </div>
        ...
        <Card className="p-6 bg-gradient-to-r from-blue-500 to-blue-600 text-white">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm opacity-90">Gerências Ativas</p>
              <p className="text-3xl font-bold">{gerenciasData.length}</p>
            </div>
        ...
        <Card className="p-6 bg-gradient-to-r from-orange-500 to-orange-600 text-white">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm opacity-90">Percentual Médio</p>
              <p className="text-3xl font-bold">23,03%</p>
            </div>
            <TrendingUp className="w-12 h-12 opacity-80" />
          </div>
